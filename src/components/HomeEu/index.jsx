...
export function HomeEu() {
    return (
        <>
            <div id="home">
                <h1 className="text-[#64ffda] mt-12 font-roboto-bold hover object-center text-left md:text-5xl"> Olá, meu nome é Marcos Porto!</h1>
                ...
                <p className="md:text-lg text-white font-roboto mr-4">Atualmente estou estudando ReactJS, TypeScript, NodeJS, TailwindCSS, NestJS, Fastify e Prisma ORM.</p>
