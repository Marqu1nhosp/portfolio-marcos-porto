      ...
      <div className="md:flex flex-row justify-center items-center gap-24">
        <div className="md:w-2/5 md:mt-6 md:mr-[26rem]">
          ...
          <p className="md:text-lg text-white font-roboto text-justify">
            ...
            melhores resultados sem deixar de lado minha evolução como
            profissional. Dedico-me ao estudo das mais recentes tecnologias,
            incluindo ReactJS, TypeScript, NextJS, Tailwind CSS, Fastify,
            ExpressJS e NodeJS.
          </p>
