...
export function HomeEu() {
    return (
        <>
            <div id="home">
                <h1 className="text-[#64ffda] md:mt-32 font-roboto-bold hover object-center text-left md:text-5xl"> Olá, meu nome é Marcos Porto!</h1>
                ...
                <p className="md:text-lg text-white font-roboto">Atualmente estou estudando ReactJS, TypeScript, NodeJS, NestJs, Prisma ORM e TailwindCSS.</p>
